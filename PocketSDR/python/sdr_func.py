...
if 'Windows' in env:
    ...
    lib = dir + '/../lib/linux_x86_64/libsdr.so'
try:
...
#  IQ-sampling with PocketSDR Q-sign convention I - j*Q), CS16/INT16X2
#  (interleaved signed int16, IQ-sampling with standard SoapySDR convention
#  I + j*Q).
#
#  args:
...
#      fmt='INT8' (I) On-disk sample format: 'INT8' / 'INT8X2' / 'CS16' /
#      'INT16X2' (optional)
#
#  returns:
